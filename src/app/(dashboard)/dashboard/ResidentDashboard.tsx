    ...
    <div className="max-w-[1600px] mx-auto p-4 lg:p-8 space-y-6 lg:space-y-8 pb-24 lg:pb-8">
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6 w-full lg:w-2/3 xl:w-[70%]">
          ...
          <div className="bg-surface-raised rounded-[2rem] p-6 lg:p-8 border border-border shadow-sm">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-bold text-text-primary tracking-tight">Visitor Management</h3>
            ...
            <div className="space-y-3">
               {/* Row 1 */}
               <div className="flex items-center justify-between p-4 rounded-2xl bg-surface border border-border hover:bg-surface-raised hover:shadow-sm hover:border-border transition-all cursor-pointer">
                 <div className="flex items-center gap-4">
                   <div className="w-12 h-12 rounded-full bg-indigo-100 flex items-center justify-center shrink-0">
                     <User className="w-6 h-6 text-indigo-600" />
                   </div>
                   <div>
                     <p className="font-bold text-text-primary">Delivery (Amazon)</p>
                     <p className="text-sm font-medium text-text-secondary">Expected Today, 2:00 PM</p>
                   </div>
                 </div>
               ...
               <div className="flex items-center justify-between p-4 rounded-2xl bg-surface border border-border hover:bg-surface-raised hover:shadow-sm hover:border-border transition-all cursor-pointer">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     <p className="font-bold text-text-primary">Ramesh (Plumber)</p>
                     <p className="text-sm font-medium text-text-secondary">Yesterday, 10:30 AM</p>
                   </div>
                 </div>
          ...
          {/* Quick Services Grid */}
          <div>
            <h3 className="text-xl font-bold text-text-primary mb-4 px-1 tracking-tight">Community Quick Links</h3>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
               {[
                 ...
                 <Link href={s.href} key={i} className="bg-surface-raised p-5 rounded-2xl border border-border shadow-sm hover:border-border-strong hover:shadow-md transition-all flex flex-col items-center justify-center gap-3 text-center group">
                   <div className="w-12 h-12 rounded-xl bg-surface border border-border flex items-center justify-center group-hover:scale-105 transition-transform">
                     <s.icon className="w-6 h-6 text-text-secondary group-hover:text-primary transition-colors" />
                   </div>
        ...
        <div className="w-full lg:w-1/3 xl:w-[30%] flex flex-col gap-6">
          ...
          <div className="bg-surface-raised rounded-[2rem] p-6 lg:p-8 border border-border shadow-sm flex-1 flex flex-col">
             <div className="flex justify-between items-center mb-6">
             ...
             <div className="relative pl-4 border-l-2 border-border space-y-6 flex-1">
                {/* Timeline item 1 */}
             ...
             <Link href="/notices" className="block mt-8">
               <button className="w-full py-3.5 rounded-xl bg-surface text-text-secondary text-sm font-bold border border-border hover:bg-surface transition-colors">
                 View All Notices
               </button>
             </Link>
          </div>
            ...
            <div className="bg-slate-900 rounded-[2rem] p-6 lg:p-8 shadow-md border border-slate-800 text-white relative overflow-hidden group hover:bg-slate-800 transition-colors">
               <div className="relative z-10 flex items-center justify-between">
                 <div>
                   ...
                   <p className="text-text-tertiary text-sm font-medium mt-1">Slot B-142 (Basement 1)</p>
                 </div>
                 <div className="w-12 h-12 rounded-full bg-surface-raised/10 flex items-center justify-center shrink-0 border border-white/10 group-hover:scale-105 transition-transform">
